...
aggrs = [repmat(20, [1,29]), repmat(40, [1,59]), repmat(50, [1,10])];
X = 30000;
H = 2000;
...
for(i = 1:length(b))
    ...
    parfor(j = 1:length(g))
        ...
        ratio_matrix(l1 - j, i) = fraction_plus;
        sup_ratio_matrix(l1 - j, i) = final_sup_ratio;
...
title('Prion stability, no initial cell')
...
xlabel('Conversion (b), ascending')
ylabel('Fragmentation(g), ascending')
title('Soluble Sup35 proportion, no initial cell')